...
contract DividendDistributor is IDividendDistributor {
    ...
    uint256 public minDistribution = 1 * (10 ** 18); // 1 DAI minimum auto send
    uint256 public minimumTokenBalanceForDividends = 100000000 * (10**9); // user must hold 100000000 token
...
contract TIEDAI is Ownable, IBEP20, SafeToken, LockToken {
    using SafeMath for uint256;
    ...
    string constant _name = "Tie Dai Token";
    string constant _symbol = "TIEDAI";
